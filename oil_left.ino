...
if(Serial.available())tmp=Serial.read();
    ...
    lcd.print("extra gas:");
    lcd.setCursor(0, 1);
lcd.print(((1/2*1.1691*0.35*182*148*(a[0]/(a[1]-a[2]))*(a[0]/(a[1]-a[2]))*a[1])/3600)
-1/2*1.1691*0.35*182*148*((a[0]/(a[1]-a[2]))+5)*((a[0]/(a[1]-a[2])+5))*a[1])/3600)/7300);               
lcd.print(“l”);
}
}
